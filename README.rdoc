...
Enhance projects table:
  - rm edit, destroy links
  - move the destroy link to inside the show page
  - Display project creation / update date to help users spot stale projects
  - sort projects by that date
  - paginate the table
