...
Writeup 1st tech tip about the problem I had with datepicker which is now in blog
...
Add opinion about javascript on ux-rant

Implement ideas presented here:
  - http://guides.rubyonrails.org/security.html

Make the flash msgs more noticeable

Use truncate() to shorten long e-mail addresses on LHS
